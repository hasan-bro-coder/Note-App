...
<form class="max-w-sm mx-auto" @submit.prevent='sign($event)'>
  <div class="mb-5">
    <label for="name" class="block mb-2 text-3xl font-medium text-gray-50 dark:text-white">Your name:</label>
  ...
  <div class="mb-5">
    <label for="email" class=" text-3xl block mb-2 font-medium text-gray-50 dark:text-white">Your email:</label>
    <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" required>
  </div>
  <div class="mb-5">
    <label for="password" class="block mb-2 text-3xl font-medium text-gray-50 dark:text-white">Your password:</label>
